...
import com.pollka.requests.PagedResponse;
import com.pollka.requests.PollRequest;
import com.pollka.requests.PollResponse;
import com.pollka.requests.VoteRequest;
...
import com.pollka.util.ModelMapper;
...
public class PollService {
    ...
    public PagedResponse<PollResponse> getAllPolls(UserInfo currentUser, int page, int size) {
